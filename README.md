...
![Build](https://github.com/GroovinChip/macos_ui_intellij/workflows/Build/badge.svg)
...
- Using IDE built-in plugin system:
  ...
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>Marketplace</kbd> > <kbd>Search for "macos_ui_intellij"</kbd> >
  <kbd>Install Plugin</kbd>
  
- Manually:

  Download the [latest release](https://github.com/GroovinChip/macos_ui_intellij/releases/latest) and install it manually using
